...
/** CUP v0.10k generated parser.
  * @version Sat May 30 18:59:47 CEST 2020
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
             ...
             Scanner scan = (Scanner)this.getScanner();  //ottengo lo scanner che stÃ  utilizzando il parser, per usare
         ...
         public void ordina_list()
         {
          ...
          public void calcola_par() {
            ...
            if(num_par!=0) //non ci si ritrova con il n di parentesi
            {
              if(num_par>0)
              {
                                                                       ...
                                                                       if(lhs.testo.contains("[") && lhs.testo.contains("]")){
                                                                         ...
                                                                         if(rec.getTabRegArr().containsKey(lhs.testo)){                                                                             
                                                                             ...
                                                                             if(lhs.tipo.equals("INTEGER")){
                                                                                ...
                                                                                Record rec = SymbolTable.retrieveVariableInsideScope(lhs.testo); //Ã¨ per ottenere SOLO il record
