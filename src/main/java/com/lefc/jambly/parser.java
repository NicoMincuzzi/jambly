...
/** CUP v0.10k generated parser.
  * @version Sun Nov 28 17:12:10 CET 2021
  */
...
Scanner scan = (Scanner) getScanner();
    ...
    public void print_error() throws IOException {
        SemanticErrorRepository semanticError = new SemanticErrorRepository();
        new ErrorParser(semanticError).print_error(error, cont_errori);
    }
...
//viene fatto alla fine della lettura o per un fatal error
public void calcola_par() {
    int num_par = scan.countBrace2;
    PrintText pt = new PrintText();

    //non ci si ritrova con il n di parentesi
    if (num_par != 0) {
        if (num_par > 0) {
