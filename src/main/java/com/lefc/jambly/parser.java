...
/** CUP v0.10k generated parser.
  * @version Mon Jun 07 00:03:30 CEST 2021
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public ArrayList<PrintText> error = new ArrayList<>(); //lista di errori con accesso casuale
    int cont_errori = 0;  //contatore errori
    boolean fatal = false;  //per un fatal error
    Scanner scan = (Scanner) this.getScanner();  //ottengo lo scanner che stÃÂ  utilizzando il parser, per usare
    // alcune funzioni del primo

    public void print_error() throws IOException {
        ErrorParser error_parser = new ErrorParser();
